...
export function IconCheck({ size = 14, ...props }: IconProps) {
  return <Svg size={size} {...props}><polyline points="20 6 9 17 4 12"/></Svg>
}

export function IconShare({ size = 14, ...props }: IconProps) {
  return (
    <Svg size={size} {...props}>
...
export function IconPencilPlus({ size = 16, ...props }: IconProps) {
  return (
    <Svg size={size} {...props}>
